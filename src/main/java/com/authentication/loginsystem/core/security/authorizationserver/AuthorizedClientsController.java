...
public class AuthorizedClientsController {
    ...
    public String clientList(Principal principal, Model model) {
        List<RegisteredClient> clients = auth2AuthorizationQueryService.listClientsWithConsent(principal.getName());
    ...
    public String revoke(Principal principal,
        ...
        List<OAuth2Authorization> authorizations = this.auth2AuthorizationQueryService.listAuthorizations(principal.getName(), registeredClient.getId());
